...
N 240 -270 240 -180 { lab=#net1}
N 190 -360 190 -90 { lab=#net2}
N 190 -360 240 -360 { lab=#net2}
N 100 -260 270 -260 { lab=#net2}
N 270 -300 270 -260 { lab=#net2}
N 240 -240 280 -240 { lab=#net1}
N 280 -390 280 -240 { lab=#net1}
N 270 -390 280 -390 { lab=#net1}
...
C {madvlsi/nmos3.sym} 240 -120 3 0 {name=M7
L=0.15
W=1
body=GND
nf=1
...
C {madvlsi/nmos3.sym} 240 -210 3 0 {name=M6
L=0.15
W=1
body=GND
nf=1
