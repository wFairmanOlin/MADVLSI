...
C {madvlsi/vsource.sym} -10 -180 0 0 {name=V1
value=1}
C {madvlsi/vsource.sym} -10 -50 0 0 {name=V2
value=1}
C {madvlsi/gnd.sym} -10 -150 0 0 {name=l3 lab=GND}
C {madvlsi/vdd.sym} -10 -210 0 0 {name=l4 lab=VDD}
C {devices/lab_pin.sym} -10 -80 2 0 {name=l5 sig_type=std_logic lab=Vin
}
C {devices/lab_pin.sym} 80 -100 0 0 {name=l6 sig_type=std_logic lab=Vin
}
C {madvlsi/gnd.sym} -10 -20 0 0 {name=l7 lab=GND}
C {devices/lab_pin.sym} 170 -100 2 0 {name=l8 sig_type=std_logic lab=Vout}
C {madvlsi/tt_models.sym} 240 -270 0 0 {
name=TT_MODELS
only_toplevel=false
value=".option wnflag=1
.lib ~/skywater/skywater-pdk/libraries/sky130_fd_pr_ngspice/latest/models/sky130.lib.spice tt"
}
C {devices/code_shown.sym} 260 -110 0 0 {name=s1 only_toplevel=false value=".dc Vin 0 1.8 .01
.save all"}
